...
export const SPECIALTIES: Record<string, SpecialtyInfo> = {
  ...
  cardiology: {
    ...
    clinics: ["rehaklinik-seewis", "klinik-schloss-mammern", "clinique-de-la-source", "hopital-de-la-tour", "clinique-des-grangettes", "clinique-de-carouge", "hirslanden-clinique-cecil", "chuv-lausanne", "hirslanden-klinik-aarau", "klinik-hirslanden"],
  },
  dermatology: {
    name: "Dermatology",
    intro:
    ...
    clinics: ["clinique-de-genolier", "clinique-generale-beaulieu", "clinique-de-la-source", "clinique-de-carouge", "chuv-lausanne", "hirslanden-clinique-bois-cerf", "klinik-hirslanden"],
  },
  endocrinology: {
    name: "Endocrinology",
    intro:
  ...
  gastroenterology: {
    ...
    clinics: ["clinique-de-la-source", "hirslanden-clinique-bois-cerf", "hirslanden-klinik-aarau", "clinique-generale-beaulieu", "clinique-de-carouge", "hirslanden-clinique-cecil", "chuv-lausanne", "klinik-hirslanden", "clinique-de-genolier"],
  },
  hematology: {
    name: "Hematology",
    intro:
    ...
    clinics: ["clinique-de-genolier", "clinique-des-grangettes", "clinique-de-la-source", "clinique-generale-beaulieu", "clinique-de-carouge", "chuv-lausanne", "klinik-hirslanden"],
  },
  checkup: {
  ...
  neurology: {
    ...
    clinics: ["cereneo-hertenstein", "rehaklinik-tschugg", "clinique-valmont", "klinik-adelheid", "clinique-de-la-source", "hopital-de-la-tour", "clinique-de-carouge", "hirslanden-clinique-cecil", "chuv-lausanne", "klinik-hirslanden"],
  },
  obgyn: {
    ...
    clinics: ["klinik-hirslanden", "clinique-des-grangettes", "clinique-generale-beaulieu", "clinique-de-la-source", "hopital-de-la-tour", "clinique-de-carouge", "hirslanden-clinique-cecil", "chuv-lausanne"],
  },
  oncology: {
    name: "Oncology",
    intro:
    ...
    clinics: ["clinique-de-genolier", "rehaklinik-seewis", "klinik-schloss-mammern", "clinique-des-grangettes", "clinique-de-la-source", "clinique-generale-beaulieu", "hirslanden-clinique-bois-cerf", "hopital-de-la-tour", "clinique-de-carouge", "chuv-lausanne", "hirslanden-klinik-aarau"],
  },
  ophthalmology: {
    name: "Ophthalmology",
    intro:
  ...
  orthopaedics: {
    ...
    clinics: ["clinique-valmont", "klinik-adelheid", "klinik-schloss-mammern", "hopital-de-la-tour", "clinique-de-la-source", "clinique-generale-beaulieu", "clinique-de-montchoisi", "hirslanden-clinique-bois-cerf", "clinique-de-carouge", "hirslanden-clinique-cecil", "chuv-lausanne", "hirslanden-klinik-aarau", "klinik-hirslanden"],
  },
  ent: {
    ...
    clinics: ["hirslanden-klinik-aarau", "clinique-de-genolier", "clinique-de-montchoisi", "clinique-generale-beaulieu", "clinique-de-carouge", "hirslanden-clinique-cecil", "chuv-lausanne"],
  },
  psychiatry: {
    name: "Psychiatry",
    intro:
    ...
    clinics: ["rehaklinik-seewis", "clinique-de-carouge", "chuv-lausanne"],
  },
  pulmonology: {
    name: "Pulmonology",
    intro:
  ...
  rheumatology: {
    ...
    clinics: ["klinik-schloss-mammern", "clinique-valmont", "clinique-de-la-source", "clinique-de-carouge", "hirslanden-clinique-bois-cerf", "hirslanden-clinique-cecil", "chuv-lausanne", "klinik-adelheid"],
  },
  urology: {
    name: "Urology",
    intro:
    ...
    clinics: ["hirslanden-klinik-aarau", "clinique-de-la-source", "clinique-generale-beaulieu", "clinique-des-grangettes", "clinique-de-carouge", "hirslanden-clinique-cecil", "chuv-lausanne", "klinik-hirslanden"],
  },
};
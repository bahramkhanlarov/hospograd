...
export function SignupForm() {
  ...
  return (
    <>
      {ref ? (
        <p className="mb-4 rounded-sm border border-primary/30 bg-primary/5 px-3 py-2 text-[0.82rem] text-foreground">
          You were invited by <span className="font-semibold">u/{ref}</span> — welcome!
        </p>
      ) : null}
